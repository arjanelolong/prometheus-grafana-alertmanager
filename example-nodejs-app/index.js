...
const server = http.createServer(async (req, res) => {
  ...
  try {
      ...
      if (route === '/test') {
        const testHttpRequestTotal = new client.Counter({
          name: 'test_endpoint_http_request_total',
          help: 'total HTTP request for test endpoint',
        });
        
        register.registerMetric(testHttpRequestTotal)
